 ...
 * generated in the client.artefact2 package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestResponse_QNAME = new QName("http://connector/", "testResponse");
    private final static QName _Test_QNAME = new QName("http://connector/", "test");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: client.artefact2
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://connector/", name = "testResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://connector/", name = "test")
